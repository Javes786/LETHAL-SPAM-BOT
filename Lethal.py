...
async def start_yukki():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@LETHAL_FIGHTERS"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await vkk(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await kkk(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await lkk(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await mkk(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await sid(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await shy(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await aan(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await ake(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await eel(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await khu(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await shi(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await dav(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await raj(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@DESTROYXOFFICIAL"))
            await put(functions.channels.JoinChannelRequest(channel="@DESTROYXSUPPORT"))
...
💥💥CONGRATULATIONS UR LETHAL SPAM BOT IS READY💥💥💥
💥💥💥💥💥💥 BY OP SAMEER 💥💥💥💥💥💥"""

print(text)
print("")
print("🙏🔥🔥SMEX! LETHAL MULTI SPAM BOT STARTED SUCCESFULLY.🔥🔥🙏")
